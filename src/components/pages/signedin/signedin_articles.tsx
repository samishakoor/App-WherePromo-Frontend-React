...
import Signedin_DetailedArticlesList from './signedin_detailedarticleslist';
import Signedin_Navbar from './signedin_navbar';

function Signedin_Articles() {
...
<div className="flex gap-5 justify-between mt-16 w-full max-md:flex-wrap max-md:mt-10 max-md:max-w-full">
      <div className="flex gap-2 justify-center px-8 py-4 text-sm font-bold tracking-tight leading-5 text-white  bg-sky-500 rounded-[100px] max-md:px-5">
        ...
        <select value={filter} onChange={handleFilterChange}>
          ...
          <div className="flex gap-5 items-start px-6 py-3.5 text-base leading-10 border border-solid border-stone-500 rounded-[32px] text-zinc-400 max-md:flex-wrap max-md:px-5 max-md:max-w-full">
      ...
      <Signedin_DetailedArticlesList filter={filter} searchQuery={searchQuery} />
...
export default Signedin_Articles;
